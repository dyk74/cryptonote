...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x391b;
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(2106201700000000);;
...
const char     CRYPTONOTE_NAME[]                             = "ticinocoin";
...
const int      P2P_DEFAULT_PORT                              = 16600;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 16700;
...
const std::initializer_list<const char*> SEED_NODES = {
  "46.140.50.98:16600", "46.14.90.118:16600"
};
